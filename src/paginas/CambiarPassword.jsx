...
const CambiarPassword = () => {
  ...
  const handleSubmit = async e => {
    ...
    if (password.pwd_nuevo !== repetirPassword.rpwd_nuevo) {
      setAlerta({ msg: 'Los nuevos password deben ser iguales', error: true });
      return;
    }
      ...
      <div className="flex justify-center">
        <div className="w-full md:w-1/2 bg-white shadow rounded-lg p-5">
          ...
          >
            ...
            <div className="my-3">
              <label className="uppercase font-bold text-gray-600">Repite tu password nuevo</label>
              <input
                type="password"
                className="border bg-gray-100 w-full p-2 mt-5 rounded-lg"
                name="rpwd_nuevo"
                placeholder="Escribe de nuevo tu nuevo password"
                onChange={e => setRepetirPassword({
                  ...repetirPassword,
                  [e.target.name]: e.target.value
                })}
              />
